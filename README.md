...
> โดยโปรแกรมจะมี 2 ฝั่งคือ ฝั่ง Server และ Client โดยรูปแบบข้อมูลที่สื่อสารกันเป็นรูปแบบ JSON โดยฝั่ง Server จะติดต่อกับระบบฐานข้อมูล MySQL อีกต่อหนึ่ง โดย Client นั้น ใช้ JavaFX ในการพัฒนาระบบ User Interface และฝั่ง Server ใช้ Spring Boot ในการพัฒนา
 ## วิธีการใช้งาน
  ...
  หากยังไม่มีบัญชีให้ทำการสมัครที่ปุ่ม Register
...
*รูปกดReadAgain
*รูปวงprofile
หรือหากต้องการเปลี่ยนหมวดหมู่ที่ชอบให้ไปที่ปุ่ม Profile ซึ่งอยู่ด้านบนขวา
*รูปเปลี่ยนข้อมูล
สามารถเข้ามาเปลี่ยนหมวดหมู่ที่ชอบได้ที่นี่ เมื่อเปลี่ยนสำเร็จแล้วให้กดที่ Save Setting
*รูปวงLogout
